...
/** 
 * DAO for table PORTADA.
*/
public class PortadaDao extends AbstractDao<Portada, Long> {

    public static final String TABLENAME = "PORTADA";

    /**
     * Properties of entity Portada.<br/>
    ...
    */
    ...
    public PortadaDao(DaoConfig config) {
        super(config);
    }
    
    public PortadaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PORTADA' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'PORTADA'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Portada entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Portada readEntity(Cursor cursor, int offset) {
        Portada entity = new Portada( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Portada entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Portada entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Portada entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

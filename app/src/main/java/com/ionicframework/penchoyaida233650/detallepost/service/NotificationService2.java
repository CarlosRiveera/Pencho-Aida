package com.ionicframework.penchoyaida233650.detallepost.service;
...
public class NotificationService2 extends Service {
    ...
    public void onCreate() {
        ...
        try {
            ...
            daoAccessCancion.Instantiate(NotificationService2.this);
    ...
    private void showNotification() {
        try {
            ...
            Intent initIntent = new Intent(this, NotificationService2.class);

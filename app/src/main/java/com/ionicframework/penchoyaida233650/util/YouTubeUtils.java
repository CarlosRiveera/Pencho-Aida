...
public class YouTubeUtils {
    private static final String TAG = LogUtils.makeLogTag(YouTubeUtils.class);
    ...
    public static void showYouTubeVideo(String videoId, Activity activity) {
        if (!TextUtils.isEmpty(videoId)) {
            ...
            if (YouTubeIntents.isYouTubeInstalled(activity) && YouTubeApiServiceUtil
                ...
                LogUtils.LOGW(TAG, "YouTube service available.");
                // start the YouTube player
                liveIntent = YouTubeStandalonePlayer.createVideoIntent(activity,
                       "AIzaSyCu4zFgGnNlB3WIwOesp3KVPnJyoI04tT8", videoId);
                ...
                // intents.
                LogUtils.LOGW(TAG, "YouTube can resolve the intent.");
                ...
                LogUtils.LOGW(TAG, "Redirecting to a browser.");
            ...
            Toast.makeText(activity, "Video no valido ",

...
// KEEP INCLUDES END
/**
 * Entity mapped to table DETALLE_PODCAST.
 */
public class DetallePodcast {
    ...
    public DetallePodcast() {
    }

    public DetallePodcast(Long id) {
        this.id = id;
    }

    public DetallePodcast(Long id, String Titulo, String SegundoTitulo, String ImagenPodcast, String Descripcion) {
        this.id = id;
        this.Titulo = Titulo;

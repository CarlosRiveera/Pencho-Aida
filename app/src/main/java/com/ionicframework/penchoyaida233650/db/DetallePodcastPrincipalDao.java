...
/** 
 * DAO for table DETALLE_PODCAST_PRINCIPAL.
*/
public class DetallePodcastPrincipalDao extends AbstractDao<DetallePodcastPrincipal, Long> {

    public static final String TABLENAME = "DETALLE_PODCAST_PRINCIPAL";

    /**
     * Properties of entity DetallePodcastPrincipal.<br/>
    ...
    */
    ...
    public DetallePodcastPrincipalDao(DaoConfig config) {
        super(config);
    }
    
    public DetallePodcastPrincipalDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DETALLE_PODCAST_PRINCIPAL' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DETALLE_PODCAST_PRINCIPAL'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DetallePodcastPrincipal entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DetallePodcastPrincipal readEntity(Cursor cursor, int offset) {
        DetallePodcastPrincipal entity = new DetallePodcastPrincipal( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DetallePodcastPrincipal entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DetallePodcastPrincipal entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DetallePodcastPrincipal entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

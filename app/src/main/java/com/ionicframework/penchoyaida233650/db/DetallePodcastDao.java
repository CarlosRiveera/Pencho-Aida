...
/** 
 * DAO for table DETALLE_PODCAST.
*/
public class DetallePodcastDao extends AbstractDao<DetallePodcast, Long> {

    public static final String TABLENAME = "DETALLE_PODCAST";

    /**
     * Properties of entity DetallePodcast.<br/>
    ...
    */
    ...
    public DetallePodcastDao(DaoConfig config) {
        super(config);
    }
    
    public DetallePodcastDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DETALLE_PODCAST' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DETALLE_PODCAST'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DetallePodcast entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DetallePodcast readEntity(Cursor cursor, int offset) {
        DetallePodcast entity = new DetallePodcast( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DetallePodcast entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DetallePodcast entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DetallePodcast entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

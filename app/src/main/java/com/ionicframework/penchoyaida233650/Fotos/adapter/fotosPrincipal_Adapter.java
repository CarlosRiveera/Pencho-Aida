 ...
 */
public class fotosPrincipal_Adapter extends BaseAdapter {
    ...
    public fotosPrincipal_Adapter(Context context, Cursor cursor) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.TituloFotoAlbum.setText(cursor.getString(7));
        imageLoader.displayImage(cursor.getString(11), holder.ImagenPrincipalAlbum, options, new ImageLoadingListener(){
            @Override

 ...
 */
public class ActivityDetallePost4 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setTitle(getResources().getString(R.string.podcast));
        ...
        Bundle extra = ActivityDetallePost4.this.getIntent().getExtras();
        posicion = (String) extra.get("posicion");
        valor = (String) extra.get("valor");

        imageLoader.init(ImageLoaderConfiguration.createDefault(ActivityDetallePost4.this));
        ...
        try {
            cursor = daoAccessDetalle.GetAllPost_principal();
            ...
            finish();
            Toast.makeText(ActivityDetallePost4.this,getResources().getString(R.string.errortrate),Toast.LENGTH_SHORT).show();
            Log.i("error", ""+ex);
        }
        initControls();
        ...
        btnplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (servidor == 0) {
                    pausaPlay.pausa(ActivityDetallePost4.this);
                    pausaPlay.pausa4(ActivityDetallePost4.this);
                    servidor = 1;
    ...
    public class EspecialTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            try {
                loading = new ProgressDialog(ActivityDetallePost4.this);
        ...
        protected Void doInBackground(Void... voids) {
            TimerTask task = new TimerTask() {
                @Override
                public void run() {
                    pausaPlay.inicio(ActivityDetallePost4.this);
                }
            };
        ...
        try {
            ...
            if(valor.equals("0")) {
                if(cursorduracion.getCount()!=0){
                    ...
                    if(cursorduracion.getString(4).equals(posicion)&&cursorduracion.getString(0).equals("4")){
                        iniciador=1;
                        pausaPlay.pausa(ActivityDetallePost4.this);
                        pausaPlay.pausa3(ActivityDetallePost4.this);
                        btnplay.setImageDrawable(getResources().getDrawable(R.mipmap.icon_pausa));
                        daoAccessDetalle.UpdateEstado("1");
                        updateProgressBar();
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                if (cursor.getCount() != 0) {
                    ...
                    Log.i("valores","val"+cursor.getString(4));
    ...
    protected void onPause() {
        ...
        if (iniciador == 1) {
           ...
           /* pausaPlay.play2(ActivityDetallePost4.this);
            player.pause();*/
        }else{
            try {
                if (!va1.equals(null)) {

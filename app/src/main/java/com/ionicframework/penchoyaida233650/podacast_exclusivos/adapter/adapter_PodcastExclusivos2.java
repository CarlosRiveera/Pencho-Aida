 ...
 */
public class adapter_PodcastExclusivos2 extends BaseAdapter {
    ...
    public adapter_PodcastExclusivos2(Context context, Cursor cursor) {
        try {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i("valor",cursor.getString(4));
        Log.i("valor",cursor.getString(3));
        urlImagenDetallePodcast = cursor.getString(3).replace("http://www.penchoyaida.com/audios/programas/","http://www.penchoyaida.com/imgpodcastpya/");
        valores =urlImagenDetallePodcast.replace("mp3","jpg");
        Log.i("valor",valores);
        imageLoader.displayImage(valores,holder.image, options);
        return view;
    }

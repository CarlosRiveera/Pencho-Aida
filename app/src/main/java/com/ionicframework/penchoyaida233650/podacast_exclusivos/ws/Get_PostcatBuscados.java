 ...
 */
public class Get_PostcatBuscados {
    ...
    public Get_PostcatBuscados(Context context, String texto){
        contexto = context;
        textoBuscado = texto;
    }
    ...
    String url = "http://penchoyaida.fm/dev/podcastEspecial.php?q=";
    public int error;
    public void Get_buscar(Context context){
        url =  context.getResources().getString(R.string.url)+"/dev/podcastEspecial.php?q=";
        ...
        try {
            ...
            for (int i = 0; i<jsonObject.length(); i++){
               ...
               content.addElement( jsonData.getString("description"));

...
// KEEP INCLUDES END
/**
 * Entity mapped to table DETALLE_PODCAST_PRINCIPAL_DEPORTES.
 */
public class DetallePodcastPrincipalDeportes {
    ...
    public DetallePodcastPrincipalDeportes() {
    }

    public DetallePodcastPrincipalDeportes(Long id) {
        this.id = id;
    }

    public DetallePodcastPrincipalDeportes(Long id, String Titulo, String SegundoTitulo, String ImagenPodcast, String Descripcion) {
        this.id = id;
        this.Titulo = Titulo;
